...
import SwapTokens from '../components/SwapTokens'; // You'll need to create this component
    ...
    <main className="min-h-screen text-white ">
      <div className="container mx-auto px-4">
        <header className="flex justify-between items-center py-4">
          ...
          <nav>
            <ul className="flex space-x-6">
              ...
              <li className="hover:text-gray-300 cursor-pointer">Last Transactions</li>
              <li className="hover:text-gray-300 cursor-pointer">Invite Friend</li>
        ...
        <div className="relative mt-40 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center z-10">
            <h1 className="text-6xl font-bold mb-4">Easy send and Request Crypto.</h1>
